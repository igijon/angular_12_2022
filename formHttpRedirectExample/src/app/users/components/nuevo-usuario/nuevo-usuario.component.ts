...
export class NuevoUsuarioComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private restUserService: RestUsersService, private notificationService: AvisosService) {
  ...
  onSubmit() {
    ...
    let user = new User(this.nuevoUsuario.value.usuario, this.nuevoUsuario.value.email, this.nuevoUsuario.value.password);
    this.onReset();
